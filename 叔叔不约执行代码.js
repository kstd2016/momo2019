...
function 全局变量(){
    ...
    联众账号 = "kstd2016";
    联众密码 = "Wentao1987223";
    微信 = Array("шēī✘","шēī♥","шēī❤","徽✘","徵♥","徾❤","幑♡","徴♡")
    ...
    套路回复[3] = Array(叔叔不约表情[random(0,叔叔不约表情.length-1)]+"有点想,污吗",叔叔不约表情[random(0,叔叔不约表情.length-1)]+微信[random(0,微信.length-1)]+"直接污吗,有点想"
...
function 关键词回复模块(){
    ...
    随机回复[1] = Array("好啊,那"+微信[random(0,微信.length-1)]+"污?方便点", "可以啊,那"+微信[random(0,微信.length-1)]+"说吧,方便语音发图")
