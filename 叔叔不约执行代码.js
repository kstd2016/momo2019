...
function 全局变量(){
    ...
    qq = 微信[random(0,微信.length-1)]+"   ссЬЬ¹995º²"
    ...
    ,叔叔不约表情[random(0,叔叔不约表情.length-1)]+"你多少岁呀")
...
function 关键词回复模块(){
    ...
    随机回复[1] = Array("好啊,那"+微信[random(0,微信.length-1)]+"污?方便点", "可以啊,那"+微信[random(0,微信.length-1)]+"说吧,方便些")
